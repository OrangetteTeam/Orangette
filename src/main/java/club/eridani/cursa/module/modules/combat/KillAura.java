...
public class KillAura extends ModuleBase {
    ...
    public void onTick(){
        ...
        EntityLivingBase  target = (EntityLivingBase) mc.world.loadedEntityList.stream().filter((entity)->entity instanceof EntityLivingBase &&entity.isEntityAlive()&&entity.getDistance(mc.player)<= 6 &&entity != mc.player).findFirst().orElse(null);
