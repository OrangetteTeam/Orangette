...
public class SplashTexture {
    ...
    public SplashTexture(String location, @Nullable ResourceLocation fallback) {
        miscPack = AccessorSplashProgress.getMiscPack();
        InputStream s = null;
        try {
    ...
    private static InputStream open(String loc, @Nullable ResourceLocation fallback) throws IOException {
