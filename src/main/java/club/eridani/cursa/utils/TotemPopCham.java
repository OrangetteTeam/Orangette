...
import club.eridani.cursa.module.modules.render.PopChams;
...
public class TotemPopCham {
    ...
    public void onRenderWorld(final RenderWorldLastEvent event) {
        ...
        Color lineColorS = new Color(PopChams.INSTANCE.rL.getValue(), PopChams.INSTANCE.bL.getValue(), PopChams.INSTANCE.gL.getValue(), PopChams.INSTANCE.aL.getValue());
